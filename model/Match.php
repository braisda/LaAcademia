...
class Match {
  ...
  */
	public function __construct($id_match=NULL, $rival1a=NULL, $rival1b=NULL,
                              ...
                              $round=NULL, $set1a=NULL, $set1b=NULL,
  ...
  /**
	...
	* @return void
	*/
	public function setSet1a($set2a) {
		$this->set2a = $set2a;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1b($set2b) {
		$this->set2b = $set2b;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1a($set3a) {
		$this->set3a = $set3a;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1b($set3b) {
		$this->set3b = $set3b;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1a($set4a) {
		$this->set4a = $set4a;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1b($set4b) {
		$this->set4b = $set4b;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1a($set5a) {
		$this->set5a = $set5a;
	}
  ...
  /**
	...
	* @return void
	*/
	public function setSet1b($set5b) {
		$this->set5b = $set5b;
	}
