...
<div id="container" class="container">
  <div id="background_title">
    <h4 id="view_title"><?= i18n("Events Reservations List") ?></h4>
  </div>
              ...
              <tbody>
                <?php $n=1; foreach ($reservations as $reservation): ?>
                      ...
                      <td>
                        ...
                        <?= $name?></td>
                      <td>
                        <a href="index.php?controller=eventReservations&amp;action=view&amp;id_reservation=<?= $reservation->getId_reservation() ?>"><span class="oi oi-magnifying-glass"></span></a>
