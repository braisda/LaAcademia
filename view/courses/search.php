...
<div class="container" id="container">
  ...
  <form enctype="multipart/form-data" action="index.php?controller=courses&amp;action=search" method="POST">
    <div id="background_table" class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input class="form-control" type="time" id="time" name="start_time">
      ...
      <div class="form-group col-md-2">
        ...
        <input class="form-control" type="time" id="time" name="end_time">
