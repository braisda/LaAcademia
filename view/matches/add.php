...
$view->setVariable("title", i18n("Add Match"));
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active"><?= i18n("Add Match") ?></li>
</ol>
  ...
  <form action="index.php?controller=matches&amp;action=add" method="POST">
    ...
    <div id="background_table" class="form-row">
      <div class="form-group col-md-3">
        ...
        <?php } ?>
        <!-- this is repeatd because the error of duplicated match -->
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set1a">
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set2a">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set3a">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set4a">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set5a">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set1b">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set2b">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set3b">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set4b">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
      ...
      <div class="form-group col-md-1">
        ...
        <input class="form-control" type="number" value="0" id="set" name="set5b">
        <?php if(isset($errors["set"])){ ?>
            <div class="alert alert-danger" role="alert">
              <strong><?= i18n("Error!") ?></strong> <?= isset($errors["set"])?i18n($errors["set"]):"" ?>
            </div>
